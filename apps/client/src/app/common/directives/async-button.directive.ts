...
// Example usage:
// <button class="ui button" app-async-button [asyncInProgress]="loading" [asyncText]="'Saving...'" [asyncType]="'save'" (click)="testClick()"></button>
...
export class AsyncButtonDirective implements OnInit, OnChanges {
  @Input() asyncInProgress: boolean = false;
